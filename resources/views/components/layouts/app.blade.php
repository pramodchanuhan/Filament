		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav m-auto mb-2 mb-lg-0">
					...
					<li class="nav-item "> <a wire:navigate class="nav-link" href="{{route('showservicepage')}}">Services</a></li>
					<li class="nav-item "> <a wire:navigate class="nav-link" href="{{route('showteampage')}}">Our Team</a></li>
		...
		<div class="row justify-content-between">
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<li class="mb-2"><a wire:navigate href="{{route('showservice', $service->id)}}">{{ $service->title }}</a></li>
					@empty
					<li class="mb-2">No Services</li>
					@endforelse
					</ul>
				</div>
			</div>
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						...
						href="{{route('showteampage')}}">Team</a>
						</li>
					</ul>
				</div>
			</div>
