                                ...
                                <div class="contact-form">
                                    ...
                                    <form wire:submit="submit">
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model.live="name" type="text" class="form-control shadow-none @error('name') is-invalid @enderror" id="name" name="name">
                                            @error('name')
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model.live="email" type="email" class="form-control shadow-none @error('email') is-invalid @enderror" id="email">
                                            @error('email')
                                            <p class="invalid_feedback">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <textarea wire:model.live="message" class="form-control shadow-none @error('message') is-invalid @enderror" id="message" rows="3"></textarea>
                                            @error('message')
                                            <p class="invalid_feedback">{{$message}}</p>
                                            @enderror
                                        </div>
